...
export class PriceCalculator {
    calculatePersonalExpense(userId: string, expense: IExpense): IExpense {
        ...
        const personalExpense = new Expense(expense.id, expense.name, expense.transactionDate, items, expense.users, expense.payers, expense.payerStatuses, expense.children);

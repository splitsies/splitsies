export const tutorialConfig = {
    home: [
        {
            key: "scanButton",
            message: "Tap here to scan a receipt. You can also create an empty expense by tapping the + in the top right. If you want to skip these tips, tap the light off icon.",
        },
        {
            key: "requests",
            message: "When someone invites you go to Splitsies, you can find them here."
        },
        {
            key: "expenseItem",
            message: "Tap an expense to open it. Once you're in, you can see everyone's edits in real-time."
        }
    ...
    expense: [
        ...
        {
            key: "editNameAndDate",
            message: "You can adjust the name and date by tapping on them at any point.",
        },
        {
            key: "selectItem",
